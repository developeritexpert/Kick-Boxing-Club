...
export default function ContentAdminPage() {
    ...
    const handleWorkoutsCardClick = () => {
        router.push(`/content-admin/workouts`);
    };
    ...
    return (
        <div className={`${styles.dashboardPage} content-admin-dsbrd`}>
            ...
            <div className={styles.cardsRow}>
                ...
                <article
                    className={styles.card}
                    onClick={handleMovementCardClick}
                    style={{ cursor: 'pointer' }}
                >
                    <div>
...
//             setError(null);
//             try {
//                 const res = await fetch('/api/content-admin/dashboard/stats', {
//                     method: 'POST',
//                     headers: {
//                         'Content-Type': 'application/json',
//                     },
...
//             <div className={styles.cardsRow}>
//                 <article className={styles.card} onClick={handleWorkoutsCardClick} style={{ cursor: 'pointer' }}>
//                     <div>
//                         <div className={styles.cardTitle}>Total Workouts</div>
//                         <div className={styles.cardValue}>{renderValue(workoutCount)}</div>
//                         <div className={styles.cardSub}>Total number of uploaded videos</div>
...
//                 <article className={styles.card} onClick={handleMovementCardClick} style={{ cursor: 'pointer' }}>
//                     <div>
//                         <div className={styles.cardTitle}>Total Movements</div>
//                         <div className={styles.cardValue}>{renderValue(movementCount)}</div>
//                         <div className={styles.cardSub}>
