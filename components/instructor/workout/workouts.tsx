...
const Workouts: React.FC = () => {
    ...
    const fetchWorkouts = async (userId: string) => {
        try {
            setLoading(true);
            const response = await fetch(`/api/instructor/workout?userId=${userId}`);
    ...
    const fetchFavorites = async (userId: string) => {
        try {
            const res = await fetch('/api/instructor/workout/favorite/list', {
                method: 'POST',
    ...
    const handleNewWorkout = () => {
        router.push('/instructor/workouts/create');
    };
    ...
    const handleHeartClick = async (e: React.MouseEvent<HTMLSpanElement>, workoutId: string) => {
        ...
        try {
            const res = await fetch('/api/instructor/workout/favorite', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    return (
        <div className="workouts-container instructor-wrkout-contnr">
