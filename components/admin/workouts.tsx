...
const Workouts: React.FC = () => {
    ...
    return (
        <div className="workouts-container">
            <div className="workouts-controls">
                ...
                <button className="add-workout-btn">Add New</button>
            </div>
   ...
   <div className="workouts-pgnatin"
     ...
     >
  <div className={`arrow left-arrow  ${activeArrow==='left'?"active":""}`}
  ...
  <div className={`arrow right-arrow ${activeArrow==='right'?"active":""}`}
